(function () {
  ...
  const NAV = [
    ...
    ["Engage",[["Customers (CRM)","👥","admin-customers.html","MANAGER"],["Reviews","⭐","admin-reviews.html","MARKETING_MANAGER,CUSTOMER_SUPPORT"],["Service Bookings","🔧","admin-service.html","CUSTOMER_SUPPORT"],["Exchange Requests","♻️","admin-exchanges.html","CUSTOMER_SUPPORT,MANAGER"],["Contact Enquiries","✉️","admin-enquiries.html","CUSTOMER_SUPPORT"],["EMI Requests","🧾","admin-emi-requests.html","CUSTOMER_SUPPORT"],["Stock Alerts","🔔","admin-stock-alerts.html","CUSTOMER_SUPPORT"],["WhatsApp Marketing","💬","admin-whatsapp.html","MARKETING_MANAGER"]]],
