...
const schema = z.object({
  // The backend accepts an email address OR a mobile number here.
      ...
      <KeyboardAvoidingView behavior={Platform.OS === "ios" ? "padding" : undefined} style={{ flex: 1 }}>
        <ScrollView contentContainerStyle={{ flexGrow: 1, justifyContent: "center" }} keyboardShouldPersistTaps="handled">
          <View style={{ alignItems: "center", marginBottom: 28 }}>
            ...
            <AppText weight="800" size={20} style={{ marginTop: 12 }}>Welcome back</AppText>
            <AppText muted size={13} style={{ marginTop: 2 }}>Sign in to your JL Enterprises account</AppText>
          </View>
