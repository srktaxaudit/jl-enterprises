...
class CouponServiceImplTest {
    ...
    void percentageCouponComputesCappedDiscount() {
        ...
        var applied = couponService.apply("SAVE10", new BigDecimal("1000"), UUID.randomUUID());
    ...
    void expiredCouponIsRejected() {
        ...
        assertThrows(BusinessException.class,
                () -> couponService.apply("OLD", new BigDecimal("1000"), UUID.randomUUID()));
    }
    ...
    void unknownCodeIsRejected() {
        ...
        assertThrows(BusinessException.class,
                () -> couponService.apply("NOPE", new BigDecimal("1000"), UUID.randomUUID()));
    }
}
