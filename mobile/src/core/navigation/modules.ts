...
export const MODULES: AdminModule[] = [
  ...
  { key: "inventory", label: "Inventory", icon: "🗂️", route: "/(app)/inventory", rule: "INVENTORY_MANAGER", group: "Catalog & Sales", built: false },
  { key: "offers", label: "Offers & Deals", icon: "🏷️", route: "/(app)/offers", rule: "MARKETING_MANAGER", group: "Catalog & Sales", built: false },
  { key: "customers", label: "Customers (CRM)", icon: "👥", route: "/(app)/customers", rule: "MANAGER", group: "Engage", built: false },
  { key: "reviews", label: "Reviews", icon: "⭐", route: "/(app)/reviews", rule: "MARKETING_MANAGER,CUSTOMER_SUPPORT", group: "Engage", built: false },
  { key: "service", label: "Service Bookings", icon: "🔧", route: "/(app)/service", rule: "CUSTOMER_SUPPORT", group: "Engage", built: false },
